...
std::string folder = "../study_cases/2_strong_scalability/";

std::string file_name_jacobi = folder + "jacobi_strong_scalability.csv";
std::string file_name_gauss_seidel = folder + "gauss_seidel_strong_scalability.csv";
