#ifndef GAUSS_SEIDEL_SEQUENTIAL_RED_BLACK_HPP
#define GAUSS_SEIDEL_SEQUENTIAL_RED_BLACK_HPP
...
class GaussSeidelSequentialRedBlack {
public: 
    ...
    */
    ...
    /*!
      \brief Tells if the current point (i,j) is red

      \param i x-component index
      \param j y-component index
      \return true if (i,j) is red
    */
...
#endif // GAUSS_SEIDEL_SEQUENTIAL_RED_BLACK_HPP